...
console.log('1. Uncurried function');
console.log(updatedJulia); // { name: 'Julia', surname: 'Álvarez', age: 25 }
console.log(julia2); // { name: 'Julia', surname: 'Álvarez', age: 19 }
console.log('Same object?', julia2 === updatedJulia); // false
...
console.log('2. Curried function');
